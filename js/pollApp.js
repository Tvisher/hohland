const questionsList = [
    {
        ...
        answerList: [
            ...
            {
                letter: "Г",
                text: 'Ранний подъем не мое. Ложусь поздно и сплю до обеда',
                type: 'F'
            },
        ]
    },
...
const testResult = {
    ...
    "I": {
        ...
        resTitle: 'У вас всегда много дел, поэтому завтрак должен быть быстрым и сытным. Уверены, что бутерброды уже надоели, поэтому предлагаем приготовить Рулет в лаваше. Времени на приготовление уйдет немного, зато вкусом насладиться успеете по полной. Даже если очень спешите.',
        ingredients: [
            {
